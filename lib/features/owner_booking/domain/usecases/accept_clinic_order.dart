...
class AcceptClinicOrder implements UseCase<NoResponse, GetClinicOrdersParams> {
  final OwnerBookingRepository ownerBookingRepository;

  AcceptClinicOrder(this.ownerBookingRepository);

  @override
  DataResponse<NoResponse> call(GetClinicOrdersParams params) async {
    return ownerBookingRepository.acceptOwnerClinicOrder(params.clinicId);
  }
}
