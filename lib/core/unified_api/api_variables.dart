...
class ApiVariables {
  ...
  ///Qr Purchase///
  ////////////////
  Uri _qr({required String path, Map<String, dynamic>? queryParameters}) => _mobileUri(
        path: 'qrCode/$path',
        queryParameters: queryParameters,
      );
  ...
  Uri indexUserInactiveQrCodeSubscriptions() => _qr(path: "subscription/indexInactive");
  Uri indexUserPreviousMiniMenuSubscriptions(Map<String, dynamic> params) => _subscription(
        path: "getUserPreviousMiniMenuSubscriptions",
        queryParameters: params,
      );
  Uri indexUserPreviousQrCodesSubscriptions(Map<String, dynamic> params) => _mobileUri(
        path: "qrCode/index",
        queryParameters: params,
      );
  ...
  Uri indexCitizenServicesRequirement(Map<String, dynamic> params) => _mobileUri(
  ...
  Uri indexInactiveContentSubscriptions(Map<String, dynamic> params) => _content(
  ...
  Uri reactivateAddressContentForUser({
    ...
    required int contentId,
      ...
      _content(
        path: "subscription/$subscriptionId/addressContent/$contentId/reactivate",
        queryParameters: params,
      );
  ...
  Uri destroyContentBuyRequest(int id) => _contentBuyRequest(path: '$id/destroy');
  /////////////////////////////
  ...
  Uri destroyContentUploadRequest(int id) => _contentUploadRequest(path: '$id/destroy');
  Uri showContentUploadRequest(int id) => _contentUploadRequest(path: '$id/show');
  ...
  Uri orderContentUpdate(int id) => _contentUpdateRequest(path: 'addressContent/$id/order');
  Uri destroyContentUpdateRequest(int id) => _contentUpdateRequest(path: '$id/destroy');
  Uri showContentUpdateRequest(int id) => _contentUpdateRequest(path: '$id/show');
  ...
  Uri destroyPostUploadRequest(int id) => _postUploadRequest(path: '$id/destroy');
  ...
  Uri destroyPostUpdateRequest(int id) => _postUpdateRequest(path: '$id/destroy');
  ...
  Uri indexInactiveShopSubscriptions(Map<String, dynamic> params) => _addressShop(
        path: "subscription/indexInactive",
        queryParameters: params,
      );
  ...
  Uri destroyShopUploadRequest(int id) => _shopUploadRequest(path: '$id/destroy');
  ...
  Uri orderShopUpdate(int id) => _shopUpdateRequest(path: 'addressShop/$id/order');
  Uri destroyShopUpdateRequest(int id) => _shopUpdateRequest(path: '$id/destroy');
  ...
  Uri updateProduct({required int productId}) => _product(path: "$productId/update");
  ///////////
  ///story///
  ///////////
  Uri _story({
  ...
  Uri destroyStoryUploadRequest(int id) => _storyUploadRequest(path: '$id/destroy');
  ...
  Uri destroyStoryUpdateRequest(int id) => _storyUpdateRequest(path: '$id/destroy');
  ...
  Uri indexInactiveNotificationSubscriptions(Map<String, dynamic> params) => _notification(
        path: "subscription/indexInactive",
        queryParameters: params,
      );
  ...
  Uri destroyNotificationBuyRequest(int id) => _notificationBuyRequest(path: '$id/destroy');
  Uri showNotificationBuyRequest(int id) => _notificationBuyRequest(path: '$id/show');
  //////////////////////////////////
  ...
  Uri destroyNotificationUploadRequest(int id) => _notificationUploadRequest(path: '$id/destroy');
  Uri showNotificationUploadRequest(int id) => _notificationUploadRequest(path: '$id/show');
  ...
  Uri orderNotificationUpdate(int id) => _notificationUpdateRequest(path: 'notification/$id/order');
  Uri destroyNotificationUpdateRequest(int id) => _notificationUpdateRequest(path: '$id/destroy');
  Uri showNotificationUpdateRequest(int id) => _notificationUpdateRequest(path: '$id/show');
  ...
  Uri indexInactiveMiniMenuSubscriptions(Map<String, dynamic> params) => _miniMenu(
        path: "subscription/indexInactive",
        queryParameters: params,
      );
  ...
  Uri destroyMiniMenuBuyRequest(int id) => _miniMenuBuyRequest(path: '$id/destroy');
  ...
  Uri destroyMiniMenuUploadRequest(int id) => _miniMenuUploadRequest(path: '$id/destroy');
  Uri showMiniMenuUploadRequest(int id) => _miniMenuUploadRequest(path: '$id/show');
  ...
  Uri orderMiniMenuUpdate(int id) => _miniMenuUpdateRequest(path: 'miniMenu/$id/order');
  Uri destroyMiniMenuUpdateRequest(int id) => _miniMenuUpdateRequest(path: '$id/destroy');
  Uri showMiniMenuUpdateRequest(int id) => _miniMenuUpdateRequest(path: '$id/show');
